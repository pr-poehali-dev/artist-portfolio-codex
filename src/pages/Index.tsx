    ...
    <div className="min-h-screen">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold tracking-tight">АЛЕКСАНДР ВОЛКОВ</h1>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-4 text-lg text-muted-foreground">
                  <p>
                    Александр Волков — современный художник, работающий на стыке абстракции и
                    концептуального искусства. Его работы исследуют взаимосвязь между внутренним
                    состоянием человека и внешним миром.
                  </p>
                  <p>
                    Родился в Москве в 1985 году. Окончил МГАХИ им. В.И. Сурикова. Участник более 50
                    выставок в России и за рубежом. Работы находятся в частных коллекциях в Европе,
                    США и Азии.
                  </p>
                  <p>
